...
Function Out-IniFile {  
    ...
    {  
        ...
        {  
            write-verbose ($InputObject[$i].GetType().Name)
            write-verbose (!($($InputObject[$i].GetType().Name) -eq "Hashtable") -or ($($InputObject[$i].GetType().Name) -eq "OrderedDictionary"))
